...
/// Test explicit fallback chains continue after unavailable and failing
/// providers.
#[test]
...
/// Test fallback aggregation maps provider creation failures to candidate
/// failures.
#[test]
...
/// Test fallback aggregation preserves provider-reported unavailable creation
/// errors.
#[test]
