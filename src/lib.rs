...
#[cfg(feature = "inventory")]
pub use inventory::ProviderRegistrationSource;
...
/// Internal dependencies used by macros generated by this crate.
///
/// This module is not part of the supported handwritten API.
#[cfg(feature = "inventory")]
#[doc(hidden)]
pub mod __private {
    pub use ::inventory;
